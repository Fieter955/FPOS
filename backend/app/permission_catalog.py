...
PERMISSION_CATALOG = [
    ...
    },
    {
        ...
        "label": "Persediaan",
        "permissions": [
            _p("inventory.item_in", "Item Masuk", CRUD + ("lock_date",)),
            _p("inventory.item_out", "Item Keluar", CRUD + ("lock_date",)),
            _p("inventory.transfer", "Transfer Item"),
            _p("inventory.branch_transfer", "Transfer Item Beda Cabang"),
            _p("inventory.opening_stock", "Saldo Awal Item", CRUD + ("lock_date",)),
            _p("inventory.stock_opname", "Stok Opname", CRUD + ("lock_date",)),
            ...
            _p("inventory.account_override", "Persediaan: Ganti Akun Jurnal", VIEW),
        ],
    },
    {
        "key": "accounting",
